    ...
    public MedicalAttendanceResponse createManualMedicalAttendance(Long patientId, FinishMedicalAttendanceRequest request) {
        ...
        MedicalAttendance medicalAttendance = medicalAttendanceRepository.save(
                MedicalAttendance.builder()
                        ...
                        .medicationsJson(ambulatoryService.writeJson(request.medications()))
                        .proceduresJson(ambulatoryService.writeJson(request.procedures()))
                        .observationPrescriptionsJson(ambulatoryService.writeJson(request.observationPrescriptions()))
                        .examsJson(ambulatoryService.writeJson(request.exams()))
                        .orientationsJson(ambulatoryService.writeJson(request.orientations()))
                        .certificatesJson(ambulatoryService.writeJson(request.certificates()))
                        .declarationsJson(ambulatoryService.writeJson(request.declarations()))
                        .recipesJson(ambulatoryService.writeJson(request.recipes()))
