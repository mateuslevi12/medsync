...
public record FinishMedicalAttendanceRequest(
        ...
        @Size(max = 1000, message = "observações médicas devem ter no máximo 1000 caracteres")
        @Pattern(regexp = "^[^<>]*$", message = "observações médicas contêm caracteres inválidos")
        String notes,
